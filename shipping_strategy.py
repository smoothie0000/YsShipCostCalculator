    ...
    def calculate(self, total_volume, total_length, province):
        ...
        if volume_m3 < 0.5:
            price_list = {
                ...
                "福建省": [135, 35], "广东省": [135, 35], "江西省": [135, 35], "山东省": [135, 35],
                "北京市": [210, 40], "天津市": [135, 35], "河北省": [135, 35], "河南省": [135, 35],
                "湖北省": [135, 35], "湖南省": [135, 35], "重庆市": [210, 35], "四川省": [210, 40],
                "贵州省": [210, 40], "山西省": [210, 35], "陕西省": [210, 35], "广西壮族自治区": [210, 40],
